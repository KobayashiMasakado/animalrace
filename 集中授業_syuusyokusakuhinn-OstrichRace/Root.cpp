...
void Root::EnemyHitMoveCreate(int course)
{
	...
	case 0:
		...
		break;
	case 1:
		SetPosition(Vector3(-84.0f, 0.0f, 87.0f));
		capsule.start = Vector3(7.0f, 0.0f, 5.0f);
		capsule.end = Vector3(-10.0f, 0.0f, -10.0f);
		capsule.r = 5.5f;
		break;
	case 2:
		SetPosition(Vector3(-12.0f, 8.0f, 95.0f));
		capsule.start = Vector3(0.0f, 0.0f, 0.0f);
		capsule.end = Vector3(-60.0f, -8.0f, 0.0f);
		break;
	case 3:
		SetPosition(Vector3(0.0f, 10.0f, 95.0f));
		capsule.start = Vector3(6.0f, 0.0f, 0.0f);
		capsule.end = Vector3(-6.0f, 0.0f, 0.0f);
		break;
	case 4:
	...
	case 16:
		...
		capsule.start = Vector3(5.0f, 0.0f, 5.0f);
		capsule.end = Vector3(-7.0f, 0.0f, -8.0f);
		break;
	case 17:
		SetPosition(Vector3(-40.0f, 0.0f,55.0f));
		capsule.start = Vector3(0.0f, 0.0f, 0.0f);
		capsule.end = Vector3(0.0f, 10.0f, -60.0f);
		break;
	case 18:
		SetPosition(Vector3(-40.0f, 10.0f, -20.0f));
		capsule.end = Vector3(0.0f, 0.0f, 7.0f);
		capsule.start = Vector3(0.0f, 0.0f, -7.0f);
		break;
	case 19:
		SetPosition(Vector3(-40.0f, 0.0f, -78.0f));
		capsule.start = Vector3(0.0f, 0.0f, 0.0f);
		capsule.end = Vector3(0.0f, 10.0f, 50.0f);
		break;
	case 20:
		SetPosition(Vector3(-50.0f, 0.0f, -95.0f));
		capsule.start = Vector3(7.0f, 0.0f, 10.0f);
		capsule.end = Vector3(-10.0f, 1.0f, -5.0f);
		capsule.r = 5.5f;
		break;
	case 21:
		SetPosition(Vector3(-70.0f, 0.0f, -100.0f));
