...
public:
	...
	void Create2(DX::DeviceResources* deviceResources, const wchar_t* name, int count);
	...
	void InitializeCorn2(float life, DirectX::SimpleMath::Vector3 pos, DirectX::SimpleMath::Vector3 dir);
...
private:
	...
	std::list<MyEffect*>		m_effectList2;
